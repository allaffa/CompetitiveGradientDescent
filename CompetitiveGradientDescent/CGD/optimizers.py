...
class CGD_shafer(Optimizer):
    ...
    def step(self, real_data, N):
        ...
        if self.solve_x:
            ...
            cg_y, self.iter_num = CGD.CGD.general_conjugate_gradient(
                grad_x=grad_y_vec,
                grad_y=grad_x_vec,
            ...
            cg_x, self.iter_num = CGD.CGD.general_conjugate_gradient(
                grad_x=grad_x_vec,
                grad_y=grad_y_vec,
...
class Newton(Optimizer):
    ...
    def step(self, real_data, N):
        ...
        p_x = CGD.CGD.general_conjugate_gradient_jacobi(
            grad_x_vec,
            self.G.parameters(),
            right_side_x,
            x=None,
        ...
        p_y = CGD.CGD.general_conjugate_gradient_jacobi(
            grad_y_vec,
            self.D.parameters(),
            right_side_y,
            x=None,
...
class CGDMultiCost(Optimizer):
    ...
    def step(self, real_data, N):
        ...
        cg_x, iter_num = CGD.CGD.general_conjugate_gradient(
            grad_x=grad_g_x_vec,
            grad_y=grad_f_y_vec,
            x_params=self.G.parameters(),
            y_params=self.D.parameters(),
        ...
        cg_y, iter_num = CGD.CGD.general_conjugate_gradient(
            grad_x=grad_f_y_vec,
            grad_y=grad_g_x_vec,
